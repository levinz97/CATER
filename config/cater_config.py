...
def add_cater_config(cfg: CfgNode):
    ...
    _C.MODEL.ROI_COORDINATE_HEAD.POOLER_RESOLUTION     = (8, 8)
    _C.MODEL.ROI_COORDINATE_HEAD.POOLER_SAMPLING_RATIO = 0
    _C.MODEL.ROI_COORDINATE_HEAD.POOLER_TYPE           = 'ROIAlignV2'
    _C.MODEL.ROI_COORDINATE_HEAD.CHANNEL_DECREASE_RATIO= 5

    _C.MODEL.ROI_COORDINATE_HEAD.CONV_HEAD_KERNEL_SIZE = 3
    _C.MODEL.ROI_COORDINATE_HEAD.NUM_STACKED_CONVS     = 3
    _C.MODEL.ROI_COORDINATE_HEAD.HIDE_IMG_SIZE         = (128, 128)
    _C.MODEL.ROI_COORDINATE_HEAD.DILATION              = 1