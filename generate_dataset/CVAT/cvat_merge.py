...
if __name__ == "__main__":
    ...
    merge_data_path = './merge_data/{}-{}.json'.format(start,end)
    cm = Cvat_merge()
    ...
    for i in range(start,int(end+1)):
        ...
        if (i==5251) or (i==5258):
            ...
            input_path = './cvat_data/{}/annotations/instances_default.json'.format(str(i))

            json_path = './json_data/CATER_new_00{}.json'.format(str(i))
            output_path= './opencv_data/CATER_new_00{}.json'.format(str(i))
            ...
            cm.add_images_and_annotations(output_path)
            cm.recheck_label()
            cm.save(merge_data_path)
            print('success!!!')